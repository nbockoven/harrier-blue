...
<html lang="en-us" data-ng-app="harrierblue">
  ...
  <body>
    ...
    <? include 'app/shared/topbar/navigation-view.html' ?>

    <div class="mt-15 container-fluid" data-ng-view><i class="fa fa-spinner fa-spin h1"></i></div>
